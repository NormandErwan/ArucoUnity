...
extern "C" {
  ...
  // TODO: au_imgproc_undistord1
  ARUCO_UNITY_API void au_imgproc_undistord2(cv::Mat* src, cv::Mat** dst, cv::Mat* cameraMatrix, cv::Mat* distCoeffs, cv::Exception* exception);
