...
extern "C" {
  ...
  ARUCO_UNITY_API int au_vectorVectorPoint2f_size1(std::vector<std::vector<cv::Point2f*>>* vector);

  ARUCO_UNITY_API int au_vectorVectorPoint2f_size2(std::vector<std::vector<cv::Point2f*>>* vector);
