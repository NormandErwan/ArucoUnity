...
extern "C" {
  ...
  ARUCO_UNITY_API double au_cv_calib3d_stereoCalibrate(std::vector<std::vector<cv::Point3f>>* objectPoints,
    ...
    cv::Mat* distCoeffs1, cv::Mat* cameraMatrix2, cv::Mat* distCoeffs2, cv::Size* imageSize, cv::Mat** R, cv::Mat** T, cv::Mat** E, cv::Mat** F,
  ...
  ARUCO_UNITY_API void au_cv_calib3d_fisheye_stereoRectify(cv::Mat* cameraMatrix1, cv::Mat* distCoeffs1, cv::Mat* cameraMatrix2,
    cv::Mat* distCoeffs2, cv::Size* imageSize, cv::Mat* R, cv::Mat* tvec, cv::Mat** R1, cv::Mat** R2, cv::Mat** P1, cv::Mat** P2, cv::Mat** Q,
